# flake8: noqa
"""
Django settings for magicalsmiles project.
...
DJANGO_ROOT = root.path('magicalsmiles')
...
WSGI_APPLICATION = 'magicalsmiles.wsgi.application'
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres:///magicalsmiles'),
}
...
WAGTAIL_SITE_NAME = "Magical Smiles"
